...
export const cellModels: CellModel[] = [
  ...
  },
  {
    ...
    description:"图示为具有叶绿体的成熟植物细胞：细胞壁提供支撑，中央液泡维持膨压；不同组织中的细胞结构有所差异。",
    hotspots:[
  ...
  },
  {
    ...
    hotspots:[
      ...
      {id:"membrane",name:"细胞膜",x:20,y:50,function:"物质交换与能量代谢",detail:"原核细胞的许多代谢过程发生在膜及胞质中。"},
      {id:"nucleoid",name:"拟核",x:50,y:48,function:"存放主要染色体 DNA",detail:"DNA 不被核膜包围，而集中在拟核区域。"},
      {id:"ribosome",name:"核糖体",x:67,y:43,function:"合成蛋白质",detail:"细菌核糖体负责把 mRNA 信息翻译成蛋白质。"},
  ...
  },
  {
    ...
    hotspots:[
      ...
      {id:"phagosome",name:"吞噬体",x:64,y:59,function:"包裹被吞入的病原体",detail:"吞噬体随后与溶酶体融合，形成降解环境。"},
      ...
      {id:"nucleus",name:"细胞核",x:45,y:48,function:"调控免疫基因表达",detail:"感染时可启动炎症因子和抗原呈递相关基因。"},
    ],
  },
  {
    ...
    hotspots:[
      {id:"process",name:"树突状突起",x:19,y:36,function:"扩大环境采样范围",detail:"细长突起帮助细胞捕获周围抗原。"},
      {id:"mhc",name:"MHC 分子",x:75,y:30,function:"展示抗原片段",detail:"成熟后迁移到淋巴结并激活初始 T 细胞。"},
  ...
  },
  {
    ...
    hotspots:[
      {id:"bcr",name:"BCR",x:24,y:23,function:"特异性识别抗原",detail:"BCR 本质上是膜结合型免疫球蛋白。"},
  ...
  },
  {
    ...
    hotspots:[
      {id:"tcr",name:"TCR",x:24,y:23,function:"识别抗原肽-MHC 复合物",detail:"TCR 不直接识别游离抗原，而识别细胞表面的复合结构。"},
  ...
  },
  {
    ...
    hotspots:[
      ...
      {id:"granules",name:"颗粒",x:69,y:33,function:"储存抗菌分子",detail:"颗粒中含有多种酶和抗菌蛋白。"},
  ...
  },
  {
    ...
    hotspots:[
      ...
      {id:"inner",name:"内膜",x:34,y:48,function:"进行电子传递和氧化磷酸化",detail:"内膜富含电子传递链复合体和 ATP 合酶。"},
      {id:"crista",name:"嵴",x:58,y:43,function:"增加内膜表面积",detail:"更多内膜面积意味着可以容纳更多能量转换蛋白。"},
  ...
  },
  {
    ...
    hotspots:[
      ...
      {id:"thylakoid",name:"类囊体",x:45,y:44,function:"进行光反应",detail:"叶绿素、光系统和电子传递链位于类囊体膜。"},
  ...
  },
  {
    ...
    hotspots:[
      {id:"dendrite",name:"树突",x:16,y:33,function:"接收来自其他细胞的输入",detail:"树突具有大量分支，可扩大突触接收面积。"},
      {id:"soma",name:"胞体",x:34,y:50,function:"整合输入并维持细胞代谢",detail:"胞体含细胞核和多数细胞器。"},
